...
const getComments = catchAsync(async(req, res, next) => {
  ...
  if(!user_id || !post_id) return next(appError(apiMessage.FIELD_FAILED, next));
...
const postComment = catchAsync(async(req, res, next) => {
  ...
  if(!user_id || !post_id || !content) return next(appError(apiMessage.FIELD_FAILED, next));
...
const updateComment = catchAsync(async(req, res, next) => {
  ...
  if(!comment_id || !user_id || !content) return next(appError(apiMessage.FIELD_FAILED, next));
...
const deleteComment = catchAsync(async(req, res, next) => {
  ...
  if(!user_id || !comment_id) return next(appError(apiMessage.FIELD_FAILED, next));
